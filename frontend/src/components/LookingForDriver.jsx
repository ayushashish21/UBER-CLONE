...
const LookingForDriver = ({ selectedRide, pickup, destination, setLookingForDriver, setWaitingForDriver }) => {
  if (!selectedRide) return null;

  // Simulating a mock backend driver match after 3 seconds
  useEffect(() => {
